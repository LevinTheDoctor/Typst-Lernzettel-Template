...
// Lernzettel: Zitieren
// =============================================================================
// Portiert aus dem FOM-Typst-Template; das Belegformat folgt dem FOM-Leitfaden
// zur formalen Gestaltung wissenschaftlicher Arbeiten (Kapitel 3 "Zitieren").
// Die Kapitelverweise in den Kommentaren beziehen sich auf diesen Leitfaden.
//
...
// Abgeschaltet wird das dokumentweit über `lernzettel(ebd: false)`, für einen
...
#let _zitierweise = state("lz-zitierweise", "chicago")
#let _ebd-aktiv = state("lz-ebd", true)
...
#let _letzter-beleg = state("lz-letzter-beleg", none)
